...
// node_modules/json2php/lib/json2php.js
var require_json2php = __commonJS({
  "node_modules/json2php/lib/json2php.js"(exports2, module2) {
    var json2php2;
    json2php2 = function(obj) {
      var i, result;
      switch (Object.prototype.toString.call(obj)) {
        ...
        case "[object Boolean]":
          ...
          break;
        case "[object Array]":
          result = "array(" + obj.map(json2php2).join(", ") + ")";
          break;
        case "[object Object]":
          result = [];
          for (i in obj) {
            if (obj.hasOwnProperty(i)) {
              result.push(json2php2(i) + " => " + json2php2(obj[i]));
            }
          }
    ...
    if (typeof module2 !== "undefined" && module2.exports) {
      module2.exports = json2php2;
      global.json2php = json2php2;
    }
  }
});
...
var json2php = require_json2php();
var md5 = require_md5();
var dependenciesMappings = {
...
var DependenciesManifest = class {
  constructor(namespace, path2) {
  ...
  getAsset() {
    const buffer2 = readFileSync(this.path);
    const hash = md5(buffer2);
    return {
...
function dependencyExtractPlugin() {
  ...
  const filter = new RegExp(
    Object.keys(dependenciesMappings).map((mod) => `^${escRe(mod)}$`).join("|")
  );
  return {
    ...
    setup(build) {
      ...
      build.onResolve({ filter }, (args) => {
        ...
        if (!dependenciesMappings[path2]) {
          throw new Error("Unknown global: " + path2);
        }
        return {
          path: path2,
      ...
      build.onLoad(
        ...
        async (args) => {
          const global2 = dependenciesMappings[args.path];
          return {
            contents: `module.exports = ${global2};`,
            loader: "js"
          };
        }
      );
...
var src_default = dependencyExtractPlugin;
